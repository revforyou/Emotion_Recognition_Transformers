...
def parse_opts():
    ...
    parser.add_argument('--n_epochs', default=1, type=int, help='Number of total epochs to run')
    ...
    parser.add_argument('--pretrain_path', default='/Users/huzexi/Downloads/multimodal-emotion-recognition/EfficientFace_Trained_on_AffectNet7.pth.tar', type=str, help='Pretrained model (.pth), efficientface')
